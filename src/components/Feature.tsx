...
export default function Feature() {
  return (
    <div className="relative py-12 sm:py-32">
      <div
        aria-hidden="true"
      ...
      >
        <div
          ...
          className="relative  left-[calc(50%+3rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 bg-gradient-to-tr from-[#ff80b5] to-[#9089fc] opacity-30 sm:left-[calc(50%+36rem)] rotate-45 sm:w-[72.1875rem]"
        />
      </div>
        ...
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
          <div className="lg:pr-8 lg:pt-4">
            <div className="lg:max-w-lg">
              ...
              <motion.dl
                className="mt-10 max-w-xl space-y-8 text-base/6 text-gray-300 lg:max-w-none"
                variants={{
                  visible: {
                    transition: {
                      delayChildren: 0.3,
